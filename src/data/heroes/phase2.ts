...
export const DROW_RANGER = hero({
  ...
  abilities: [
    ...
    { id: 'drow-multishot', name: 'Multishot', targeting: 'no-target', castRange: 850, castPoint: 0.2, manaCost: [50, 60, 70, 80], cooldown: [24, 22, 20, 18], channel: { duration: 1.5, offField: true, tick: { interval: 0.5, effects: [{ kind: 'damage', dtype: 'physical', amount: 'damage', target: 'enemies-in-radius', radius: 'radius' }] } }, values: { damage: [60, 90, 120, 150], radius: [760, 760, 760, 760] }, vfx: { archetype: 'storm', color: '#9fd8ff' } },
...
export const WITCH_DOCTOR = hero({
  ...
  abilities: [
    ...
    { id: 'wd-death-ward', name: 'Death Ward', targeting: 'unit-target', affects: 'enemy', ult: true, castRange: 600, castPoint: 0.3, manaCost: [200, 250, 300], cooldown: [90, 80, 70], channel: { duration: 'duration', offField: true, tick: { interval: 0.35, effects: [{ kind: 'damage', dtype: 'physical', amount: 'damage', target: 'target' }] } }, values: { damage: [80, 130, 180], duration: [4, 5, 6] }, effects: [], vfx: { archetype: 'channel', color: '#f4e37a', color2: '#39c46a', scale: 1.1 } }
  ]
